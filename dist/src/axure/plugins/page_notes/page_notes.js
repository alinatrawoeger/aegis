...
(function () {
    ...
    $(window.document).ready(function () {
            ...
            if ($axure.document.configuration.showAnnotationsSidebar) {
                ...
                if (widgetNoteUi.length > 0) {
                    ...
                    $('.widgetNoteContainer').click(function () {
                        ...
                        if (!wasSelected)
                            $(this).addClass('widgetNoteContainerSelected');
        ...
        $axure.page.bind('load.page_notes', function () {
            ...
            if (hasNotes)
                $('#pageNotesEmptyState').hide();
            else
                $('#pageNotesEmptyState').show();
    ...
    var _toggleAnnDialog = function (id, srcLeft, srcTop, page) {
        ...
        var left = 0;
        if (blnAbove)
            top = sourceTop - height - 20;
        else
            top = sourceTop + 10;
        if (blnLeft)
            left = sourceLeft - width - 4;
        else
            left = sourceLeft - 6;
...
//# sourceMappingURL=page_notes.js.map